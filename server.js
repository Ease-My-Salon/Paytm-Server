...
app.post('/generateTxnToken', function (request, res) {
    ...
    // Change MID and Test Merchant Key(key_secret)
    var paytmParams = {};
    var MID = "kkSLQl61462535628018";
    var key_secret = "wUw@otw_xpog6@bQ";
    ...
    var callbackUrl = `https://securegw.paytm.in/theia/paytmCallback?mid=kkSLQl61462535628018&ORDER_ID=` + orderId;
    ...
    checksum_lib.genchecksumbystring(JSON.stringify(paytmParams.body), key_secret, (err, checksum) => {
        ...
        var options = {
            ...
            port: 443,
            path: '/theia/api/v1/initiateTransaction?mid=kkSLQl61462535628018&orderId=' + orderId,
            method: 'POST',
            headers: {
